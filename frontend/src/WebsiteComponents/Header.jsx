...
export default function Header({ scrollToSection }) {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-[60px]  backdrop-blur-xl dark:bg-blur dark:text-white shadow-md z-50 flex flex-row justify-between items-center px-5 transition-all duration-300">
            ...
            {/* Navigation Menu */}
            <div className="flex flex-row space-x-10 font-semibold text-sm md:text-md text-black dark:text-white">
                <h3 className="cursor-pointer hover:text-gray-500 dark:hover:text-gray-300" onClick={() => scrollToSection("about-me")}>
                    ABOUT ME
                </h3>
